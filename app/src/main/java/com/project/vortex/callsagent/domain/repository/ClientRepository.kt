...
interface ClientRepository {
    ...
    /**
     * Observe active clients (INTERESTED or CITED) that have NO active
     * follow-up (PENDING/EXPIRED). Drives the "Sin agendar" section in Agenda.
     */
    fun observeUnscheduledActive(): Flow<List<Client>>
